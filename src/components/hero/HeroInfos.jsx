...
const HeroInfos = () => {
  return (
    <ul className={styles.container}>
      <li className={styles.box} data-aos="fade-down">
      ...
      <li className={styles.box} data-aos="fade-down" data-aos-delay="100">
        <div className={styles.iconBox} tabIndex={0}>
      ...
      <li className={styles.box} data-aos="fade-down" data-aos-delay="200">
        <div className={styles.iconBox} tabIndex={0}>
